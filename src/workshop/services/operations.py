...
class OperationsService:
    ...
    def get_id(self, user_id: int, operation_id: int) -> tables.Operation:
        operation = (
            self.session
    ...
    def get_list_no_auth(self, kind: Optional[OperationKind] = None) -> List[tables.Operation]:
    ...
    def get_by_id(self, user_id: int, operation_id: int) -> tables.Operation:
        return self.get_id(user_id, operation_id)
    ...
    def update(self, user_id: int, operation_id: int, operation_data: OperationUpdate) -> tables.Operation:
        operation = self.get_id(user_id, operation_id)
